...
_system_map = {
    "perception_neuron": {"data_format": "global_pose", "channel": "pos_global", "channel_display": "pos_global"},
    "xsens": {"data_format": "mvnx_segment", "channel": "pos", "channel_display": "pos_global"},
}


def absolute_movement(
    data: pd.DataFrame, data_format: str | None = "global_pose", system: str | None = "perception_neuron", **kwargs
) -> pd.DataFrame:
    ...
    body_part_name, body_part = _extract_body_part(system=system, body_parts=kwargs.get("body_part"))
